...
- **Nothing is deleted automatically.** Recordings accumulate for as long as you keep them - roughly 34GB a year at a daily ten-minute session. Settings shows the folder's current size so the number isn't invisible.
